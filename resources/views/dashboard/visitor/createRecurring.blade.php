@section('title', 'Tambah Tamu Berulang')
@section('header', 'Tambah Tamu Berulang')
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default class="static">
                ...
                <form action="{{ route('visitor.store.recurring') }}" method="POST" enctype="multipart/form-data"
                    class="p-6">
                    @csrf
