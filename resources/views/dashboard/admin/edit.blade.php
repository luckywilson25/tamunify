    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default class="static">
                ...
                <x-form action="{{ route('admin.update', $admin->id) }}" class="md:grid md:grid-cols-2 gap-4"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="email" class="mt-1 w-full" type="text" name="email"
                            :value="old('email', $admin->email)" required autofocus autocomplete="email" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.select-input id="department" class="mt-1 w-full" type="text" name="department">
                            ...
                            <option value="{{ $department->value }}" {{ old('department', $admin->
