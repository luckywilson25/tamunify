            ...
            @if(session('data'))
                ...
                <div class="text-center p-6">
                    <p class="text-gray-600 mb-6">
                        Data pendaftaran akses berulang Anda telah berhasil disubmit. Tim kami akan memproses pendaftaran
                        Anda.
                    </p>
                    ...
                    <div class="bg-[#006838] border border-[#006838] rounded-lg p-4 mb-6 text-green-100 ">
                        ...
                        <div class="flex items-center justify-center gap-2 text-sm">
                            ...
                            <p class="text-sm mb-4 text-green-100 ">
                                Pendaftaran akses berulang Anda sedang dalam proses review. Kami akan mengirimkan email
                                konfirmasi dalam 1-3 hari kerja.
                            </p>
                        </div>
                    ...
                    <div class="text-sm text-gray-600 text-left space-y-2">
                        ...
                        <ul class="list-disc list-outside pl-5 space-y-1">
                            ...
                            <li>Jika disetujui, Anda akan menerima email konfirmasi dengan detail pengambilan kartu akses
                            </li>
